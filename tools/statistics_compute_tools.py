...
@tool("compute_outliers")
def compute_outliers_tool(data_str: str, threshold: float = 3.0) -> str:
  """Identify statistical outliers in a NumPy ndarray along the 0 axis.
  ...
  Args:
    data_str (str): A 2d NumPy array containing the input data in string format. The outliers 
      will be computed along the 0 axis.
    threshold(float): The z-score threshold for identifying the outlier. Defaults to 3.0

  Returns:
    string representation of boolen type indicating if the particular value is an outlier or not.
  ...
  # Identify the outliers based on the threshold.
  return str(np.abs(zscores) > threshold)
...
@tool("compute_iqr")
def compute_iqr_tool(data_str: str) -> str:
  """Compute Interquartile range (IQR) of a NumPy array along the axis 0.
  ...
  Args: 
    data(str): A String representation of 2d NumPy array containing the input data. The IQR will be 
      computed along the 0 axis.
  
  Returns:
    str: A string representation of 1D Numpy array with IQR values for each column of the input array.
...
@tool("compute_mean")
def compute_mean_tool(data_str: str) -> str:
  """Computes the mean of a NumPy ndarray along the axis 0.
  
  Args:
    data (str): A string representation of n-dimension numpy array for which the mean should be calculated.

  Returns:
    str: A string representation of the computed mean along the axis 0 in a np.ndarray format.
  ...
  if not data:
    ...
    return str(np.mean(data, axis=0))
...
@tool("compute_kurtosis")
def compute_kurtosis_tool(data_str: str) -> str:
  """
  Compute the kurtosis of a NumPy ndarray along the 0 axis.

  Args:
    data_str (str): A string representation of 2D NumPy array containing the input data. The kurtosis 
                      will be computed along the 0 axis.

  Returns:
    str: A string representation of 1D NumPy array containing the kurtosis values for each column 
                of the input array.
  ...
  # Compute kurtosis along the 0 axis
  return str(kurtosis(data, axis=0, fisher=True, nan_policy='omit'))
...
@tool("compute_skewness")
def compute_skewness_tool(data_str: str) -> str:
  """
  Compute the skewness of a NumPy ndarray along the 0 axis.

  Args:
    data_str (str): A string representation of 2D NumPy array containing the input data. The skewness 
                      will be computed along the 0 axis.

  Returns:
    str: A string representation of 1D NumPy array containing the skewness values for each column 
                of the input array.
  ...
  # Compute skewness along the 0 axis
  return str(skew(data, axis=0, nan_policy='omit'))
...
@tool("compute_mode")
def compute_mode_tool(data_str: str) -> str:
  """
  Compute the mode of a NumPy ndarray along the 0 axis.

  Args:
    data_str (str): A string representation of 2D NumPy array containing the input data. The mode 
                      will be computed along the 0 axis.

  Returns:
    str: A string representation of 1D NumPy array containing the mode values for each column 
                of the input array.
  ...
  # Compute mode along the 0 axis
  return str(mode(data, axis=0, nan_policy='omit').mode[0])
...
@tool("compute_median")
def compute_median_tool(data_str: str) -> str:
  """
  Compute the median of a NumPy ndarray along the 0 axis.

  Args:
    data_str (str): A string representation of 2D NumPy array containing the input data. The median 
                      will be computed along the 0 axis.

  Returns:
    str: A string representation of 1D NumPy array containing the median values for each column 
                of the input array.
  ...
  # Compute median along the 0 axis
  return str(np.median(data, axis=0))
...
def compute_variance_tool(data_str: str) -> str:
  """
  Compute the variance of a NumPy ndarray along the 0 axis.

  Args:
    data_str (str): A string representation of 2D NumPy array containing the input data. The variance 
                      will be computed along the 0 axis.

  Returns:
    str: A string representation of 1D NumPy array containing the variance values for each column 
                of the input array.
  ...
  # Compute variance along the 0 axis
  return str(np.var(data, axis=0, ddof=0))
